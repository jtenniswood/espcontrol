...
const CARD_TYPE_PICKER_DETAILS: Readonly<Record<string, PickerDetails>> = {
  ...
  wifi_qr: { icon: "wifi", description: "Open guest Wifi connection details from a named card." },
  wifi_qr_card: { icon: "qrcode", description: "Show the guest Wifi QR code directly on the card." },
