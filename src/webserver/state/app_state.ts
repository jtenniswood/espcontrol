...
export function createInitialState(deviceConfig: DeviceConfig): AppState {
  ...
  return {
    ...
    agendaViewDays: 30, agendaViewHideEmpty: false,
    ...
    photosFolder: "", photosInterval: 30, photosShuffle: false, photosShowDatetime: true, photosShowDate: true,
    photosShowWeather: false, photosWeatherEntity: "", photosShowAgenda: false, photosAgendaEntities: "", photosAgendaStyle: "Next Event", photosAgendaOpacity: 45, photosAgendaLimit: 5, photosAgendaDays: 14, photosAgendaHideEmpty: false,
