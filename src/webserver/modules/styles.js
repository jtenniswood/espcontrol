var CSS =
  ...
  ".sp-disclosure{border:1px solid var(--border);border-radius:8px;background:rgba(255,255,255,.02);overflow:hidden;margin-top:14px}" +
  ".sp-disclosure:first-child{margin-top:4px}" +
