...
export const GENERATED_ICON_NAMES: readonly string[] = [
    ...
    "Chair Rolling", "Chef Hat", "Chevron Down", "Chevron Up", "Coach Lamp", "Coach Lamp Variant",
    "Clock", "Circle Outline", "Coffee Maker", "Current AC", "Current DC", "Curtains",
    "Curtains Closed", "Delete", "Delete Empty", "Delete Outline", "Desk", "Desk Lamp",
    "Desk Lamp Off", "Desk Lamp On", "Dishwasher", "Dishwasher Off", "Dog", "Downlight",
    ...
    "Folder Music Outline", "Folder Play", "Fountain", "Fridge", "Gamepad", "Garage",
    ...
    "Grid Off", "Headphones", "Radiator", "Radiator Off", "Home", "Home Lightbulb",
    "Home Lightbulb Outline", "Heat Pump", "Heat Wave", "Heating Coil", "HVAC", "HVAC Off",
    "Hot Tub", "Humidifier", "Humidity Alert", "Iron", "Kettle", "Key",
    "Lamp", "Lamp Outline", "Lava Lamp", "LAN", "Lawnmower", "Robot Mower",
