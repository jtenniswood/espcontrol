...
export const GENERATED_ICON_NAMES: readonly string[] = [
    ...
    "LAN", "Lawnmower", "Robot Mower", "Robot Mower Outline", "Leaf", "LED Strip",
    "LED Strip Variant", "LED Strip Variant Off", "Light Switch", "Flood Light Down", "Lightbulb", "Lightbulb Auto",
    "Lightbulb Auto Outline", "Lightbulb Fluorescent Tube Outline", "Lightbulb Group", "Lightbulb Group Outline", "Lightbulb Night", "Lightbulb Night Outline",
    "Lightbulb Off", "Lightbulb On 50", "Lightbulb On Outline", "Lightbulb Spot", "Lightbulb Spot Off", "Lightbulb Variant",
    "Lightbulb Variant Outline", "Lightbulb Outline", "Lightning Bolt", "Lock", "Lock Open", "Lock Open Outline",
    "Lock Open Variant", "Lock Outline", "Mailbox", "Message Video", "Medication", "Medication Outline",
    ...
    "Music Box Multiple", "Music Note", "Music Note Quarter", "Nintendo Switch", "Outdoor Lamp", "Oven",
    "Palette", "Package", "Package Closed", "Pill", "Pill Multiple", "Plus",
    "Pause", "Play", "Play Pause", "PlayStation", "Pool", "Post Lamp",
    "Power", "Power Plug", "Progress Clock", "Printer", "Printer 3D", "Projector",
    "Projector Off", "Recycle", "Remote Back", "Remote Desktop", "Remote Down", "Remote Home",
    "Remote Left", "Remote OK", "Remote Right", "Remote Up", "Remote TV", "Robot Vacuum",
    ...
    "Sofa Single Outline", "Solar Panel", "Solar Panel Large", "Solar Power", "Solar Power Variant", "Speaker",
    ...
    "Home-Thermostat", "Thermostat Auto", "Thermometer Water", "Timer", "Toilet", "Toy Brick",
