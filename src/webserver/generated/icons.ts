...
export const GENERATED_ICON_NAMES: readonly string[] = [
    ...
    "Play Pause", "PlayStation", "Pool", "Post Lamp", "Power", "Power Plug",
    "Progress Clock", "Printer", "Printer 3D", "Projector", "Projector Off", "Recycle",
    "Remote Back", "Remote Desktop", "Remote Down", "Remote Home", "Remote Left", "Remote OK",
    "Remote Right", "Remote Up", "Remote TV", "Robot Vacuum", "Robot Vacuum Alert", "Robot Vacuum Off",
    ...
    "Snowflake Thermometer", "Silverware", "Sofa", "Sofa Outline", "Sofa Single Outline", "Solar Panel",
    ...
    "Thermometer Water", "Timer", "Toilet", "Toy Brick", "Track Light", "Track Light Off",
    "Transmission Tower", "Trash Can", "Trash Can Outline", "Vacuum", "Vacuum Outline", "View Headline",
    "Video", "Video Outline", "Volume High", "Volume Off", "Wall Outlet", "Wall Sconce",
