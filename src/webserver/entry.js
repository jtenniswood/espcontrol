...
(function () {
  ...
  var ICON_NAMES = [
    ...
    "Fireplace", "Flash", "Floor Lamp", "Format Text", "Fountain", "Fridge",
    ...
    "Sync", "Power Socket UK", "Power Socket EU", "Power Socket US", "Sun", "Table",
    ...
    "Thermometer Water", "Timer", "Toggle Switch", "Toggle Switch Variant Off", "Toilet", "Transmission Tower",
    "Trash Can", "Trash Can Outline", "Tune Vertical Variant", "Volume High", "Wall Outlet", "Wall Sconce",
    "Washing Machine", "Washing Machine Off", "Water", "Water Boiler", "Water Boiler Off", "Water Percent",
    "Water Alert", "Webhook", "Weather Cloudy", "Weather Cloudy Alert", "Weather Dust", "Weather Fog",
