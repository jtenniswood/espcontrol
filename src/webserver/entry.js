...
(function () {
  ...
  var ICON_NAMES = [
    ...
    "Fire Off", "Fireplace", "Flash", "Floor Lamp", "Format Text", "Fountain",
    ...
    "Lock", "Lock Open", "Lock Open Outline", "Lock Outline", "Mailbox", "Map Clock",
    ...
    "Home-Thermostat", "Thermostat Auto", "Thermometer Water", "Timer", "Toggle Switch", "Toggle Switch Variant Off",
    "Toilet", "Transmission Tower", "Trash Can", "Trash Can Outline", "Tune Vertical Variant", "Volume High",
    "Wall Outlet", "Wall Sconce", "Washing Machine", "Washing Machine Off", "Water", "Water Boiler",
    "Water Boiler Off", "Water Percent", "Water Alert", "Webhook", "Weather Cloudy", "Weather Cloudy Alert",
