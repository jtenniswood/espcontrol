...
(function () {
  ...
  var ICON_NAMES = [
    ...
    "Blinds Horizontal", "Blinds Horizontal Closed", "Blinds Open", "Bluetooth", "Broom", "Calendar Month",
    ...
    "Chevron Up", "Clock", "Coffee Maker", "Counter", "Current AC", "Current DC",
    ...
    "Fire", "Fire Off", "Fireplace", "Flash", "Floor Lamp", "Format Text",
    "Form Dropdown", "Fountain", "Fridge", "Gamepad", "Garage", "Garage Open",
    "Garage Open Variant", "Garage Variant", "Gate", "Gate Open", "Gesture Tap", "Gesture Tap Button",
    "Gauge", "Gauge Empty", "Gauge Full", "Gauge Low", "Grid Export", "Grid Import",
    "Grid Off", "Headphones", "Radiator", "Radiator Off", "Home", "Home Automation",
    ...
    "Lock Open Outline", "Lock Outline", "Mailbox", "Map Clock", "Message Video", "Medication",
    "Medication Outline", "Meter Electric", "Meter Gas", "Microsoft Xbox", "Microwave", "Minus",
    "Monitor", "Motion Sensor", "Motion Sensor Off", "Movie Roll", "Movie Open", "Music",
    ...
    "Roller Shade", "Roller Shade Closed", "Router", "Router Network", "Security", "Script Text Play",
    ...
    "Stove", "Swap Horizontal", "Sync", "Power Socket UK", "Power Socket EU", "Power Socket US",
    ...
    "Home-Thermostat", "Thermostat Auto", "Thermometer Water", "Timer", "Toggle Switch", "Toggle Switch Variant",
    "Toggle Switch Variant Off", "Toilet", "Transmission Tower", "Trash Can", "Trash Can Outline", "Tune Vertical Variant",
    "Volume High", "Wall Outlet", "Wall Sconce", "Washing Machine", "Washing Machine Off", "Water",
    "Water Boiler", "Water Boiler Off", "Water Percent", "Water Alert", "Webhook", "Weather Cloudy",
