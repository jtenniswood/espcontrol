...
export function createWebStyles(dragAnimation: boolean): string {
    return ":root{" +
        ...
        ".sp-companion-note{margin-top:0}.sp-companion-status{margin:0 0 16px;color:var(--text2);font-size:.86rem}.sp-companion-details{display:grid;gap:10px;margin:0 0 16px;padding:14px;border:1px solid var(--border);border-radius:10px;background:var(--surface2)}" +
