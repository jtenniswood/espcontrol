...
export function createWebStyles(dragAnimation: boolean): string {
    return ":root{" +
        ...
        ".sp-notification-message{max-width:100%;overflow:hidden}" +
        ".sp-notification-message .sp-sensor-value{white-space:nowrap;overflow:hidden;text-overflow:ellipsis}" +
        ...
        ".sp-notification-legend{display:flex;flex-wrap:wrap;gap:8px}" +
        ".sp-notification-chip{display:inline-flex;align-items:center;gap:5px;padding:4px 10px;" +
        "border-radius:999px;font-size:.78rem;font-weight:500;line-height:1.3}" +
