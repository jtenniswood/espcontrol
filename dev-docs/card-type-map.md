...
| `local_sensor` | Local Sensor | `src/webserver/types/local_sensor.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_grid.h` | `sensor`, `text_sensor` | Yes | None | Visible | Contract, Codec, Parser, HA |
