...
| `weather` | Weather | `src/webserver/types/weather.js` | `components/espcontrol/button_grid_cards.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h`, `components/espcontrol/button_grid_subscriptions.h` | `weather` | Yes | Type: default, today, tomorrow, 3day; Large Temperature Numbers | Visible | Contract, Codec, Parser, HA, Backup |
