...
| `climate` | Climate | `src/webserver/types/climate.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `climate` | Yes | Label Display: label, status, actual, target; Icon & Temperatures: icon, actual, target; Large Temperature Numbers; Show dial on large cards | Visible | Contract, Codec, Parser, HA, Modals, Backup |
...
| `weather` | Weather | `src/webserver/types/weather.js` | `components/espcontrol/button_grid_cards.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h`, `components/espcontrol/button_grid_subscriptions.h` | `weather` | Yes | Type: default, today, tomorrow, hero, daily_strip, hourly_strip; Large Temperature Numbers | Visible | Contract, Codec, Parser, HA, Backup |
