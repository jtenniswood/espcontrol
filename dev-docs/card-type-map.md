...
| `ha_calendar` | Calendar | `src/webserver/types/ha-calendar.js` | `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_ha_calendar.h` | `calendar` | Yes | Type: current, next_event; Next event highlight; Progress indicator; Minutes before event: 1, 2, 3, 5, 10; Next event now time: 1, 2, 3, 5, 10 | Visible | Contract, Codec, Parser, HA, Backup |
