...
| `timer` | Timer | `src/webserver/types/timer.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `timer` | Yes | None | Visible | Contract, Codec, Parser, HA |
