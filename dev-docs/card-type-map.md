...
| `vacuum` | Vacuum | `src/webserver/types/vacuum.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_vacuum.h` | `vacuum` | Yes | Type: modal, status, start_stop, dock, pause_resume, clean_spot, locate, clean_area; Modal Tabs: controls, rooms, fan; Rooms | Visible | Contract, Codec, Parser, HA, Backup |
