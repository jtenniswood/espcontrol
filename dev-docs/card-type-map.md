...
| `image` | Camera Card | `src/webserver/types/image.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_camera.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `camera`, `image` | Yes | Show Label; Show Icon; Expanded Image: fill, fit | Visible | Contract, Codec, Parser, HA, Modals, Backup |
