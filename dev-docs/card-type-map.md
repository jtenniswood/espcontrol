...
| `lawn_mower` | Lawn Mower | `src/webserver/types/lawn_mower.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_lawn_mower.h` | `lawn_mower` | Yes | Type: status, control_panel, start_mowing, dock, pause_resume | Visible | Contract, Codec, Parser, HA, Backup |
