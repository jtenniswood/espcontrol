...
| `media` | Media | `src/webserver/types/media.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_media.h`, `components/espcontrol/button_grid_subpages.h` | `media_player` | Yes | Type: control_modal, play_pause, previous, next, volume, position, now_playing, playlist; Type: default, state; Controls: default, progress, play_pause; Show Cover Art; Maximum Volume; Label Display: label, status; Top Left Display: icon, volume; Media Content ID / URI; Player Source / Input; Large Media Numbers | Visible | Contract, Codec, Parser, HA, Modals, Backup |
