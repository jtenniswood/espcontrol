...
| [plants.md](../docs/card-types/plants.md) | `plant` |
...
| `plant` | Plant | `src/webserver/types/plant.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h` | `plant` | Yes | Type: status, moisture, battery, temperature, conductivity, brightness; Large Metric Numbers | Visible | Contract, Codec, Parser, HA, Backup |
