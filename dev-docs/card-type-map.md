...
| `media` | Media | `src/webserver/types/media.js` | `components/espcontrol/button_grid_actions.h`, `components/espcontrol/button_grid_config.h`, `components/espcontrol/button_grid_grid.h`, `components/espcontrol/button_grid_subpages.h` | `media_player` | Yes | Type: play_pause, previous, next, volume, position, now_playing; Type: default, state; Controls: default, progress, play_pause; Show Cover Art; Maximum Volume; Large Media Numbers | Visible | Contract, Codec, Parser, HA, Modals, Backup |
