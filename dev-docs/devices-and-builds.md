...
| `ESPCONTROL_IMAGE_CARD_MAX_CONTEXTS=2` | `guition-esp32-s3-4848s040` | Limits S3 camera and media cover-art cards to two shared image contexts to preserve memory headroom. | Image context capacity is generated from device profile data or a larger pool is validated on the S3. |
