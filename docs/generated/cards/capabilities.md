...
| Climate | climate | climate | Yes | Own picker item | Label Display: label, status, actual, target; Icon & Temperatures: icon, actual, target; Large Temperature Numbers; Show dial on large cards | Visible |
