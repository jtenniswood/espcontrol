...
| Vacuum | vacuum | vacuum | Yes | Own picker item | Type: modal, status, start_stop, dock, pause_resume, clean_spot, locate, clean_area; Modal Tabs: controls, rooms, fan; Rooms | Visible |
