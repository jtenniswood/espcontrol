...
| Media | media | media_player | Yes | Own picker item | Type: control_modal, play_pause, previous, next, volume, position, now_playing, playlist; Type: default, state; Controls: default, progress, play_pause; Show Cover Art; Maximum Volume: 1-100; Label Display: label, status; Top Left Display: icon, volume; Media Content ID / URI; Player Source / Input; Large Media Numbers | Visible |
