...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      'The setup page includes Switch, Lights, Action, Option Select, Webhook, Trigger, Sensor, Plant, Doors & Windows, Presence, Slider, Fans, Vacuum, Lawn Mower, Cover, Garage Door, Lock, Alarm, Date & Time, World Clock, Weather, Camera, Media, Climate, Internal Switches, Screen Lock, and Subpage cards.',
  },
  {
    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Plant', link: '/card-types/plants' },
