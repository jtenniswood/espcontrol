...
- **Current card types** — Switch, Lights, Action, Option Select, Trigger, Sensor, Slider, Cover, Garage Door, Lock, Date & Time, World Clock, Weather, Media, Climate, and Internal Switches
