...
Subpages can contain Switch, Action, Trigger, Sensor, Slider, Cover, Climate, Garage Door, Date, Weather, and Weather Forecast cards. They cannot contain another Subpage card.
