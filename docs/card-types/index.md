...
| Let visitors scan guest Wi-Fi details | [Wi-Fi Share](/card-types/wifi-share) | No entity required |
...
- **Wi-Fi Share** stores separately configured guest-network credentials on the panel.
