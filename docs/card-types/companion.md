...
description: Show Mac system statistics, launch applications, open Finder folders, control media, open web links, or replay keyboard shortcuts from a 4848S040 EspControl panel.
---
...
3. Open the panel's browser editor, then go to **Connectors → Mac Companion** and choose **Start pairing**.
