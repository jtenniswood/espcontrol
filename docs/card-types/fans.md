...
|---|---|---|
| **All Controls** | Opens a large modal with power, speed, preset, oscillation, and direction tabs. Unsupported tabs are hidden automatically. | The relevant fan features exposed by the integration |
...
- **All Controls** opens a full-screen fan view. It can show tabs for Power, Speed, Preset, Oscillation, and Direction. The panel hides tabs that the selected fan does not support.
