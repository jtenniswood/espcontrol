...
def load_companion_capabilities_data():
    ...
    if not isinstance(security, dict) or security.get("pairingAuthorization") != "physical_presence":
        raise BuildError("Companion pairing must require physical presence")
