...
def gen_saved_config_shadow_ts(data):
    ...
    return (
        ...
        "// =============================================================================\n"
        "import type { CardConfig, CardNormalizationSpec, MigrationActionSpec, NormalizationCondition, SavedConfigField } from \"../contracts/types\";\n"
        "\n"
        ...
        "  const actual = condition.source === \"field\" ? config[condition.name as SavedConfigField] : \"\";\n"
        "  let matches = false;\n"
        ...
        "  for (const field of Object.keys(spec.fields) as SavedConfigField[]) {\n"
