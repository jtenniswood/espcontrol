...
TASKS = (
    ...
    task("generated", ("python3", "scripts/build.py", "--check"),
         ...
         generated_inputs=("components/espcontrol/*_generated.h", "src/webserver/generated/companion_capabilities.ts", "macos/Companion/Sources/Companion/CompanionCapabilities.generated.swift", "product/generated/companion_manifest.json", "docs/generated/**", "docs/public/**", "product/product_snapshot.json"),
    ...
    task("companion-contract", ("python3", "scripts/check_companion_contract.py"),
         ...
         inputs=("product/v2/companion_capabilities.json", "product/generated/companion_manifest.json", "components/companion/**", "components/espcontrol/companion_*", "src/webserver/cards/companion.ts", "src/webserver/model/companion_card.ts", "src/webserver/application/settings_companion_section.ts", "src/webserver/generated/companion_capabilities.ts", "macos/Companion/Sources/Companion/**", "scripts/check_companion_contract.py"),
         parallel_safe=True),
