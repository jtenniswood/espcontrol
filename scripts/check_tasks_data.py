...
TASKS = (
    ...
    task("firmware-modal-layouts", ("python3", "scripts/check_firmware_modal_layouts.py"),
         ...
         domains=("firmware", "product"), inputs=("common/config/modal_layout_geometry_fixtures.json", "components/espcontrol/button_grid_modal_layout.h", "devices/catalog.json", "scripts/device_profiles.py", "scripts/check_firmware_modal_layouts.py"),
         parallel_safe=True, cache_tools=("c++", "g++", "clang++")),
