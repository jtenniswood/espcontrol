...
TASKS = (
    ...
    task("mutations", ("python3", "scripts/run_mutations.py"),
         ...
         inputs=("tests/mutations/**", "tests/firmware/**", "tests/web/*.test.ts", "tests/web/unit/**", "components/espcontrol/configuration_service.*", "components/espcontrol/panel_config_service_validator.h", "components/espcontrol/panel_config_legacy_adapter.*", "components/espcontrol/panel_config_storage_backend.h", "components/espcontrol/panel_config_espidf_storage.*", "components/espcontrol/configuration_store.*", "components/espcontrol/panel_config_document.h", "src/webserver/model/**", "src/webserver/generated/**", "scripts/run_mutations.py"),
         cache="never"),
    ...
    task("config", ("node", "scripts/run_web_compat_check.js", "config"), profiles=FAST,
         domains=("product", "web"), inputs=("common/config/**", "src/webserver/**", "tests/web/*.test.ts", "tests/web/unit/**", "product/v2/product_compatibility.json", "scripts/check_config_formats.js", "scripts/run_web_compat_check.js", "scripts/load_typescript_module.js") + WEB_SOURCE_HELPERS + WEB_BUNDLE_INPUTS,
