...
constexpr const char *CARD_CONTRACT_OPTION_NAME_LOCK_DISPLAY = "lock_display";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_PIN = "pin";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_UNLOCK = "unlock";
