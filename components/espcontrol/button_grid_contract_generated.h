...
constexpr const char *CARD_CONTRACT_OPTION_NAME_PLANT_MODE = "plant_mode";
...
constexpr const char *CARD_CONTRACT_OPTION_NAME_PRECISION = "precision";
...
inline bool card_contract_large_numbers_supported(const std::string &type, const std::string &precision) {
  ...
  return type == "" || type == "action" || type == "calendar" || type == "clock" || type == "climate" ||
         type == "climate_control" || type == "media" || type == "subpage" || type == "timezone";
}
