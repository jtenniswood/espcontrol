...
inline CardRuntimeSpec card_runtime_spec(CardTypeId type) {
  switch (type) {
    ...
    case CardTypeId::CLIMATE: return {type, CardDriverId::CLIMATE, static_cast<uint16_t>(CAPABILITY_SUBSCRIPTIONS | CAPABILITY_RUNTIME_ALLOCATION | CAPABILITY_SUBPAGE)};
    case CardTypeId::CLIMATE_CONTROL: return {type, CardDriverId::CLIMATE, static_cast<uint16_t>(CAPABILITY_SUBSCRIPTIONS | CAPABILITY_ACTIONS | CAPABILITY_NUMERIC_CONTROL | CAPABILITY_RUNTIME_ALLOCATION | CAPABILITY_SUBPAGE)};
