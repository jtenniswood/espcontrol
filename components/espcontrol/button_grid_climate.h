...
constexpr lv_coord_t CLIMATE_MODAL_JC4880P443_OPTION_TILE_MAX_PX = 176;
constexpr lv_coord_t CLIMATE_MODAL_JC4880P443_OPTION_TILE_MIN_PX = 150;
constexpr lv_coord_t CLIMATE_MODAL_JC4880P443_OPTION_TILE_H_PX = 108;
...
inline void climate_open_inline_option_list(ClimateControlCtx *ctx, const std::string &kind) {
  ...
  auto add_section = [&](lv_obj_t *parent,
    ...
    for (const auto &option : section_options) {
      ...
      lv_obj_set_style_border_width(btn, 0, LV_PART_MAIN);
      lv_obj_set_style_shadow_width(btn, 0, LV_PART_MAIN);
      lv_obj_set_style_pad_top(btn, jc4880p443_layout ? 0 : 12, LV_PART_MAIN);
      lv_obj_set_style_pad_bottom(btn, jc4880p443_layout ? 0 : 12, LV_PART_MAIN);
