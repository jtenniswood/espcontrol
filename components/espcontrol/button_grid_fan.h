...
inline void fan_control_apply_power(FanCardCtx *ctx) {
  ...
  fan_control_style_binary_button(
    ui.power_off_btn, !ctx->on, SECONDARY_GREY, SECONDARY_GREY, DARK_TEXT_PRIMARY, true);
}
...
inline void fan_control_apply_oscillation(FanCardCtx *ctx) {
  ...
  fan_control_style_binary_button(
    ui.oscillation_off_btn, !ctx->oscillating, SECONDARY_GREY, SECONDARY_GREY, DARK_TEXT_PRIMARY, true);
}
